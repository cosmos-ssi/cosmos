FUNCTION(LOAD_PLATFORM PLATFORM)
    ...
    list(APPEND PLATFORMS "x86-64" "arm")

    # target platform sources
    file(GLOB_RECURSE PLATFORM_SRCS CONFIGURE_DEPENDS 
        "sys/${PLATFORM}/*.c"
        "sys/${PLATFORM}/*.h"
        "sys/${PLATFORM}/*.asm"
        "obj/${PLATFORM}/*.c"
    ...
    foreach (ITR ${PLATFORMS})
        file(GLOB_RECURSE _IGNORE CONFIGURE_DEPENDS 
            "sys/${ITR}/*.c"
            "sys/${ITR}/*.h"
            "sys/${ITR}/*.asm"
            "obj/${ITR}/*.c"
    ...
    set(PLATFORM_LAYOUT ${PLATFORM_LAYOUT} PARENT_SCOPE)
    set(ALL_PLATFORM_SRCS ${ALL_PLATFORM_SRCS} PARENT_SCOPE)
