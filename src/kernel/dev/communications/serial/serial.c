...
#include <dev/communications/serial/ns16550.h>
#include <dev/communications/serial/serial.h>
...
SUBSYSTEM_DRIVER(serial, "Serial Port", "16550 UART-based serial port", "Tom Everett", "", "0.1", 0x32ee38a5ad331bf3,
                 0x017cae2ac60d3661, 0xb19a85be97f460a1, 0x306cc0425dc8b9f3, SUBSYSTEM_ID_COMMUNICATIONS, &serial_init);
 ...
 */
driver_initialization_function_t serial_init(driver_list_entry_t* dle, void* comm_driver) {
    ASSERT_NOT_NULL(obj);
