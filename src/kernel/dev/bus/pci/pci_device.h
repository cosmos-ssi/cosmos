...
typedef void (*pciobjectSearchCallback)(struct pci_device* dev);
...
struct arraylist* pci_search_class_subclass(pci_class_codes pci_class, uint8_t pci_subclass, struct arraylist* out);
