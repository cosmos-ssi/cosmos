 ...
 */
typedef void (*blockutil_read_sector_function)(struct device* dev, uint32_t sector, uint8_t* data, uint32_t count);
typedef void (*blockutil_write_sector_function)(struct device* dev, uint32_t sector, uint8_t* data, uint32_t count);
...
struct deviceapi_block {
    blockutil_read_sector_function read;
    blockutil_write_sector_function write;
